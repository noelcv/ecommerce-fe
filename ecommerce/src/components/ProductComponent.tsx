...
const ProductComponent: FunctionComponent<ProductType> = ({
  ...
  return (
    <div className="grid gap-1 grid-cols-2  shadow-lg items-center justify-center m-2.5 p-8 max-h-auto z-10 bg-zinc-300 min-w-min max-w-full hover:bg-zinc-200">
