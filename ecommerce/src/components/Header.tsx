...
const Header: FunctionComponent = () => {
  ...
  return (
    <div className="grid grid-cols-12 md:flex md:flex-row pb-2 bg-zinc-800 sticky z-2 w-screen md:pr-32">
      ...
      <div className="grid ml-12 col-start-1 col-end-2 grid-flow-col md:col-end-10 md:flex md:flex-row md:mr-16">
        <Link to="/admin">
      ...
      <div className="flex space-x-2 mt-16 -ml-2 md:mt-0 md:ml-3 md:place-content-even 3xl:ml-80 3xl:space-x-20 4xl:space-x-20 4xl:ml-96">
